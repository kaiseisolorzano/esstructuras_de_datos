...
class App(ctk.CTk):
    ...
    def crear_layout(self):
        ...
        self.search_button.grid(row=5, column=0, padx=20, pady=5, sticky="ew")
        ...
        self.undo_button.grid(row=6, column=0, padx=20, pady=(5, 10), sticky="ew")
    ...
    def buscar_tarea(self):
        """Función de Búsqueda: Busca tareas por título."""
